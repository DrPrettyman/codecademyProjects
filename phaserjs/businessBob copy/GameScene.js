...
class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    function assignCoords() {
      ...
      // If the coordinates are already in gameState.numCoordinates, 
  ...
  update() {
	...
	if (bobXCoord <= 32 || bobXCoord >= 448) {this.endGame()}
	if (bobYCoord <= 32 || bobYCoord >= 568) {this.endGame()}
